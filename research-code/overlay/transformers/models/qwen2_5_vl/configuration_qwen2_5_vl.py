...
class Qwen2_5_VLVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.anomaly_query_mode = str(anomaly_query_mode or "single").strip().lower()
        if self.anomaly_query_mode not in {"single", "multiscale"}:
            raise ValueError(
                f"Unsupported anomaly_query_mode: {anomaly_query_mode!r}; "
                "expected 'single' or 'multiscale'."
            )
